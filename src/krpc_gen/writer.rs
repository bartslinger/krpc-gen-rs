...
pub fn write_to_file(service_name: &str, path: &str, _output_structure: &output::OutputStructure) {
...
//    data.insert("service_getters".to_string(), handlebars::to_json(getters));
